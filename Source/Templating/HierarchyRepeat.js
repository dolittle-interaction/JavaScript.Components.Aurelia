...
@templateController
@inject(BindingEngine, BoundViewFactory, TargetInstruction, ViewSlot, ViewResources, ObserverLocator, RepeatStrategyLocator)
export class HierarchyRepeatChildren extends AbstractRepeater {
    static viewFactory;
    @bindable local;
    @bindable items;

    constructor(bindingEngine, viewFactory, instruction, viewSlot, viewResources, observerLocator, strategyLocator) {
        //super(viewFactory, instruction, viewSlot, viewResources, observerLocator, strategyLocator);
        super({
            local: 'component',
        ...
        //instruction.behaviorInstructions[0].attributes.items = bindingExpression;
        //debugger;
